...
function Folders() {
  ...
  useEffect(() => {
    ...
    axios.get("https://video-noting-web-app-80f672477ea7.herokuapp.com/folders", {headers: {accessToken: localStorage.getItem('accessToken')}})
    .then((response) => {
  ...
  const handleDelete = (id) => {
    ...
    if(proceed) {
      ...
      axios.delete(`https://video-noting-web-app-80f672477ea7.herokuapp.com/folders/${id}`, {headers: {accessToken: localStorage.getItem("accessToken")}})
      .then((response) => {
