...
function UserProfile() {
  ...
  const handleClick = (item) => {
    ...
    axios.post("https://video-noting-web-app-80f672477ea7.herokuapp.com/videos", {video : item}, {headers: {accessToken: localStorage.getItem("accessToken")}}).then((response) => {
  ...
  useEffect(() => {
    ...
    axios.get("https://video-noting-web-app-80f672477ea7.herokuapp.com/notes", {headers: {accessToken: localStorage.getItem("accessToken")}}).then((response) => {
